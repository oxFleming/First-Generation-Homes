...
const cards = [
  {
    ...
    svg: (
      <svg viewBox="0 0 400 400" className="absolute -right-10 -bottom-10 w-[120%] h-[120%] opacity-[0.07] pointer-events-none">
        <circle className="card-path" cx="200" cy="200" r="150" fill="none" stroke="#000" strokeWidth="2" />
        <circle className="card-path" cx="200" cy="200" r="100" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 50 200 L 350 200" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 200 50 L 200 350" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 94 94 L 306 306" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 94 306 L 306 94" fill="none" stroke="#000" strokeWidth="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 400 400" className="absolute -right-10 -bottom-10 w-[120%] h-[120%] opacity-[0.07] pointer-events-none">
        <rect className="card-path" x="100" y="150" width="200" height="150" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 80 150 L 200 50 L 320 150 Z" fill="none" stroke="#000" strokeWidth="2" />
        <rect className="card-path" x="160" y="200" width="80" height="100" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 100 150 L 300 150" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 200 50 L 200 300" fill="none" stroke="#000" strokeWidth="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 400 400" className="absolute -right-10 -bottom-10 w-[120%] h-[120%] opacity-[0.07] pointer-events-none">
        <path className="card-path" d="M 100 350 L 100 150 L 200 100 L 300 150 L 300 350 Z" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 100 200 L 300 200" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 100 250 L 300 250" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 100 300 L 300 300" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 150 150 L 150 350" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 200 100 L 200 350" fill="none" stroke="#000" strokeWidth="2" />
        <path className="card-path" d="M 250 150 L 250 350" fill="none" stroke="#000" strokeWidth="2" />
      </svg>
    )
  }
];
  ...
  return (
    <div ref={containerRef} className="relative w-full h-screen bg-[#fafafa] overflow-hidden flex items-center justify-center" data-theme="light">
      ...
      {cards.map((card, index) => (
        ...
        >
          {/* Text Side */}
          <div className="relative w-full md:w-1/2 h-1/2 md:h-full p-8 md:p-16 flex flex-col justify-center bg-[#fafafa] overflow-hidden">
            {/* SVG Path Background */}
            {card.svg}

            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                <span className="text-xl font-mono text-gray-400">{card.step}</span>
                <div className="h-[1px] w-12 bg-gray-300" />
              </div>
              <h3 className="text-4xl md:text-5xl font-serif tracking-tight text-gray-900 mb-6">
                {card.title}
              </h3>
